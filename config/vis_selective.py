...
class AdvCfg():
    ...
    def get_net_cfg(self):
        net_cfg = dict()
        net_cfg["network"] = "simpl.simple_earlyexit:Simpl"
        ...
        # new ones 
        net_cfg["exit_layer"] = 1
        net_cfg["eval_output"] = "selective"
        net_cfg["selective_threshold"] = 0.50
        net_cfg["selective_score"] = "top1_prob"
    ...
    def get_loss_cfg(self):
        loss_cfg = dict()
        loss_cfg["loss_fn"] = "simpl.av2_earlyexit_loss_fn:LossFunc"
        ...
        # New ones
        loss_cfg["exit_loss_coef"] = 0.5
        loss_cfg["distill_cls_coef"] = 0.0
        loss_cfg["distill_reg_coef"] = 0.0
        loss_cfg["latency_gap_coef"] = 0.0
        loss_cfg["latency_savings"] = 0.0
        loss_cfg["policy_loss_coef"] = 0.0

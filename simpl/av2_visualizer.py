...
print("USING VIS FILE:", __file__, flush=True)
...
class Visualizer():
    ...
    def draw_once(self, post_out, data, eval_out, show_map=False, test_mode=False, split='val'):
        print(">>> ENTER draw_once <<<", flush=True)
        ...
        save_path = f"vis_outputs/{seq_id}.png"
        # out_dir = "/storage/ice-shared/cs7643/group-a/Early-exits-in-motion-forecasting/vis_outputs"
        # os.makedirs(out_dir, exist_ok=True)
        # save_path = os.path.join(out_dir, f"{seq_id}.png")
        # out_dir = f"/home/hice1/trussell47/vis_outputs"
        # os.makedirs(out_dir, exist_ok=True)
        # plt.savefig(save_path, dpi=200)
        # plt.close()
        # print(f"[Saved] {save_path}")

        out_dir = os.path.expanduser("~/vis_outputs")
        os.makedirs(out_dir, exist_ok=True)
